 ...
 * @endcode
 */
$settings['hash_salt'] = 'PTIDqvVWThxPUiz7Pvm3ypS7Jg3ftb18XSBvnhwLP7fCEN-TdA9sm-7KK7uI9AWvovor72OXVQ';
...
// Charger configuration Railway
if (getenv('RAILWAY_ENVIRONMENT')) {
  include $app_root . '/' . $site_path . '/settings.railway.php';
}
